function Contact() {
  return (
    <div>
      ...
      <h1 className="text-4xl font-bold mb-4 text-blue-500 items-center text-center mb-6">سوالی دارید فرم زیر را پر کنید</h1>
      <section className="items-center justify-center flex mb-9  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2">
        
        <section className="flex items-center justify-center mb-9  px-2">
          <div className="relative group overflow-hidden rounded-2xl shadow-lg bg-gradient-to-br from-light-blue-500 to-deep-blue-600 h-full w-full max-w-4xl flex justify-center items-center">
            <div className="bg-white rounded-2xl shadow-sm shadow-sky-500 outline outline-blue-400 -outline-offset-8 w-full p-6">
