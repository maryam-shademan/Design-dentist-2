              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    مرکز دندانپزشکی دکتر گلشاه، با بهره‌گیری از تیمی متخصص و باتجربه، پیشرو
                    در زمینه طراحی لبخند و ارائه خدمات تخصصی و درمانی دندانپزشکی است. این
                    مرکز با استفاده از جدیدترین متدهای طراحی لبخند و بروزترین تکنولوژی و
                    تجهیزات ایمپلنت، لبخندی زیبا و طبیعی را برای بیماران خود به ارمغان
                    می‌آورد.
                  </p>
                  <>
